...
function start()
{
   ...
   var b = document.getElementById("formLegend");
...
function check()
{
   ...
   {
      alert(Base64.decode("UGxlYXNlIGVudGVyIHBob25lIG51bWJlciBjb3JyZWN0bHkhISE="));
   }
   else if (titlequestion.value == "")
   {
      alert(Base64.decode("UGxlYXNlIGVudGVyIHF1ZXN0aW9uIHRpdGxlISEh"));
   }
   else if (email.value != "" && phone.value != "" && phone.value.length > 7 && titlequestion != "")
   {
